...
class InnerGiveAwayAdapter(var giveAway: List<GiveAway>, var context: Context) :
    RecyclerView.Adapter<InnerGiveAwayAdapter.GiveAwayViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): InnerGiveAwayAdapter.GiveAwayViewHolder {
